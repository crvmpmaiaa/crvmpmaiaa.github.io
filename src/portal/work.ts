...
export const ALL_PROJECTS: Project[] = [
  ...
  { slug: "ucl", name: "UCL", kind: "iOS app and backend", tags: ["ios", "backend", "operations"], line: "Shifts, vehicles, earnings and safety for a working crew, with the reporting the business needed behind it.", image: "/images/work/ucl.webp", site: "/images/work/ucl.webp", alt: "UCL app home screen", url: "" },
