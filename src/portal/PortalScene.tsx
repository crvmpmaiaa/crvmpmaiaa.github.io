...
import { ShaderQuad, type ShaderName } from "./ShaderBackdrop";
...
export function PortalWorld({ material = "marble", video, lit, onSelect, standalone = false, backdrop = "shader", frozen = false, active, bare = false, variant = 0, shader = "geode" }: { material?: "marble" | "glass"; video?: HTMLVideoElement | null; lit: React.MutableRefObject<number>[]; onSelect?: (i: number) => void; standalone?: boolean; backdrop?: "shader" | "video"; frozen?: boolean; active?: () => boolean; bare?: boolean; variant?: number; shader?: ShaderName }) {
  ...
  return (
    <group ref={root}>
      ...
      {backdrop === "shader" && <ShaderQuad frozen={frozen} variant={variant} shader={shader} />}
