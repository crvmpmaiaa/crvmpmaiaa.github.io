...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    lead: "The site, plus the engine that sends people to it.",
    points: ["Landing pages that convert", "Paid ads on Meta and Google", "Search that compounds over time", "Monthly reports"],
  },
  {
    title: "Custom Application Builds",
    image: "/images/services/apps.webp",
    alt: "Marble gears meshing, lit from within",
    lead: "Apps and backends shaped around how your business actually runs.",
    points: ["iOS and Android apps, shipped to the stores", "Backends, databases and admin dashboards", "Scheduling, teams, roles and permissions", "Integrations with the tools you already run"],
  },
  {
