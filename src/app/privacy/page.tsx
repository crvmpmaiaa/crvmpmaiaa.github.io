    ...
    <main className="wp wp--article">
      ...
      <article className="wp__body">
        ...
        <section>
          ...
          <p>This site has no forms and collects nothing about you. If you email us, message us on WhatsApp or book a call, we keep what you give us: your name, your email address or phone number, your message and the time you booked. Please do not include sensitive information.</p>
        ...
        <section>
          <h2>Where it goes</h2>
          <p>Emails arrive in our inbox and call bookings are made through Google Calendar, both run by Google Workspace. WhatsApp messages are handled by Meta under its own privacy policy. Google may store data in the United States, under the UK International Data Transfer Addendum and the UK extension to the EU and US Data Privacy Framework. Netlify, which hosts this site, keeps standard server logs, including IP addresses, for security.</p>
        </section>
        <section>
