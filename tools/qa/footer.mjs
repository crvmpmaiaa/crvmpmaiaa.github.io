...
const [url = "http://localhost:3000", out = "assets/shots/footer.png"] = process.argv.slice(2);
...
await pg.screenshot({ path: out }); console.log("footer", errs.slice(0, 3)); await b.close();
